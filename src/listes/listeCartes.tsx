...
import { PlusFormations } from "../composants/carte/PlusFormations";
...
export const listeCompetences: Carte[] = [
  {
    ...
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(244,165,25,0.5)] md:shadow-none  md:hover:shadow-[7px_5px_0px_-1px_rgba(244,165,25,0.5)] hover:z-1",
  ...
  },
  {
    ...
    couleur: "#6C8A18",
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(108,138,24,0.5)] md:shadow-none  md:hover:shadow-[7px_5px_0px_-1px_rgba(108,138,24,0.5)] hover:z-1",
  ...
  },
  {
    ...
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(9,65,150,0.5)] md:shadow-none  md:hover:shadow-[7px_5px_0px_-1px_rgba(9,65,150,0.5)] hover:z-1",
    position: "md:absolute md:bottom-0 md:left-0 md:rotate-5",
  },
  {
    id: 3,
    titre: "Formations et diplômes",
...
export const listeInterets: Carte[] = [
  {
    ...
    couleur: "#F4A519",
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(244,165,25,0.5)] md:shadow-none md:hover:shadow-[7px_5px_0px_-1px_rgba(244,165,25,0.5)] md:hover:z-1",
    position: "md:-rotate-5 relative md:left-9",
  },

  {
    ...
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(9,65,150,0.5)] md:shadow-none md:hover:shadow-[7px_5px_0px_-1px_rgba(9,65,150,0.5)] hover:z-1",
    position: "md:rotate-5 relative md:left-3.5 md:bottom-3",
  },
  {
    id: 3,
    titre: "Ecriture",
    ...
    couleur: "#00A651",
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(0,166,81,0.5)] md:shadow-none md:hover:shadow-[7px_5px_0px_-1px_rgba(0,166,81,0.5)] hover:z-1",
    position: "md:-rotate-5 relative md:right-3.5",
  },
  {
    id: 4,
    titre: "Sports",
    ...
    couleurOmbre:
      "shadow-[7px_5px_0px_-1px_rgba(228,38,24,0.5)] md:shadow-none md:hover:shadow-[7px_5px_0px_-1px_rgba(228,38,24,0.5)] hover:z-1",
    position: "md:rotate-5 relative md:right-9 md:bottom-3",
  },
];
